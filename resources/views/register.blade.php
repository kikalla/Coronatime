    ...
    <section class="flex flex-col mt-[3%] mr-[20%] ml-[10%] w-[52%] px-[2%] mob:mx-[13%] mob:w-[100%] mob:mt-[10%]">
        ...
        <div>
            ...
            <form action="/">
                ...
                <div class="flex flex-col my-[2%] mob:my-[7%]">
                    <label class="font-bold" for="">Repeat password</label>
                    <input class="outline-none my-[1%] p-[3%] mob:p-[5%] border rounded-xl border-[#808189]" placeholder="Repeat password" type="password" name="">
                </div>
                ...
                <button class="hover:scale-[99%] w-[100%] text-white font-extrabold rounded-xl bg-[#0FBA68] p-[3%] mb-[3%] mob:my-[5%] mob:p-[5%]">SIGN UP</button>
            </form>
