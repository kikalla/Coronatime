...
<body class="2xl:text-2xl text-xs">
    <section class="flex flex-col items-center mt-[3%] px-[2%] mob:mx-[13%] mob:mt-[10%]">
        ...
        <div class="flex flex-col items-center">
            <h2 class="font-extrabold text-center text-xl 2xl:text-4xl mb-[20%] mt-[60%] mob:mt-[30%]">{{__('mainTranslation.reset_password')}}</h2>
            ...
            <form class="w-[150%]" action="" method="POST">
                ...
                <button class="hover:scale-[99%] w-[100%] text-white font-extrabold rounded-xl bg-[#0FBA68] p-[3%] mb-[3%] mob:my-[5%] mob:p-[5%]" type="submit">{{__('mainTranslation.reset_Password_up')}}</button>
            </form>
        </div>
    </section>    
</body>
